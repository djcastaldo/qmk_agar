...
// This function disables bottom RGB LEDs if configured to do so
...
void led_set_user(uint8_t usb_led)
{
    ...
    // Update once in fixed color mode. Otherwise, when turning off LED, indicator light color is not updated.

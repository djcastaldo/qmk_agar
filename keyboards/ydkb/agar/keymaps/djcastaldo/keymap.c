...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [SFT_LAYR] = LAYOUT_60_tsangan_hhkb(
        ...
        _______, MK_ACCEL2, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______,  KC_P1, KC_P2, KC_P3, WM_STATB, _______, MO(FKEY_LAYR),
        _______, _______, MK_ACCEL0, KC_P0,  KC_PDOT, _______, _______
    ),
    [SFT_LAYR_NAV] = LAYOUT_60_tsangan_hhkb(
        WM_QUIT, WM_SOC1, WM_SOC2, WM_SOC3, WM_SOC4, WM_SOC5, WM_SOC6, WM_SOC7, WM_SOC8, WM_SOC9, WM_SOC0,KC_VOLD,KC_VOLU,KC_NUM, WM_OVIEW,
        KC_APP, WM_QLOOK, WM_INSPECT, WM_VHIDDEN, _______,  WM_TIME, _______,KC_P7,KC_P8,KC_MS_BTN1, KC_MS_UP, KC_MS_BTN2, CURSORR,_______,
        _______, WM_APPS, WM_SIRCAT, WM_DOCS, WM_MYCM, KC_MYCM, _______,    KC_P4, KC_P5, KC_MS_LEFT, KC_MS_DOWN, KC_MS_RIGHT, _______,
        _______, MK_ACCEL2, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______,  KC_P1, KC_P2, MK_HOLD, KC_CALC, _______, _______,
        _______, _______, MK_ACCEL0, KC_P0,  KC_PDOT, _______, _______
    ),
    ...
    [MSYM_LAYR] = LAYOUT_60_tsangan_hhkb(
        SUITH, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS,
        SUITD, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, _______,
        SUITC, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, _______,
        _______, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, LTRANS, NBSP, SUITS,
        _______, _______, SUP1, _______, SUP2, SUP3, _______
    ),

    [WSYM_LAYR] = LAYOUT_60_tsangan_hhkb(
        SUITH, TD(ACT_1), OPT2, OPT3, OPT4, OPT5, OPT6, OPT7, OPT8, OPT9, OPT0, OPTMIN, OPTEQ, OPTBSL, TD(ACT_GRV),
        SUITD, OPTQ, OPTW, TD(ACT_E), OPTR, OPTT, OPTY, TD(ACT_U), TD(ACT_I), OPTO, OPTP, OPTLBR, OPTRBR, _______,
        SUITC, OPTA, OPTS, OPTD, OPTF, OPTG, OPTH, OPTJ, OPTK, OPTL,  OPTSEM, OPTAPO, _______,
        _______, OPTZ, OPTX, OPTC, OPTV, OPTB, TD(ACT_N), OPTM, OPTCOM, OPTDOT, OPTSLS, NBSP, SUITS,
        _______, _______, SUP1, _______, SUP2, SUP3, _______
    ),
    ...
    [WIDE_LAYR] = LAYOUT_60_tsangan_hhkb(
        ...
        _______, _______, BARTEXT, KC_MPLY, UNDERLN, STHRU, _______
    ),

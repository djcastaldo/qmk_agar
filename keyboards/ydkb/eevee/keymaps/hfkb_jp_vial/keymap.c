...
{
  {
    {KC_ESCAPE, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINUS, KC_EQUAL, KC_JYEN},
    {KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_LBRACKET, KC_RBRACKET, KC_ENTER},
    {KC_LCTRL, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCOLON, KC_QUOTE, KC_NONUS_HASH, KC_BSPACE},
    {KC_LSHIFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMMA, KC_DOT, KC_SLASH, KC_RO, KC_UP, KC_RSHIFT},
    {KC_F13, KC_GRAVE, KC_LGUI, KC_LALT, KC_MHEN, KC_NO, KC_SPACE, KC_SPACE, KC_HENK, KC_KANA, KC_RALT, KC_LEFT, KC_DOWN, KC_RIGHT}
  },

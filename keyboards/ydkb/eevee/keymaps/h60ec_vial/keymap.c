...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  {
    ...
    {KC_LCTRL, KC_LGUI, KC_LALT, KC_NO, KC_NO, KC_NO, KC_SPACE, KC_SPACE, KC_SPACE, KC_NO, MO(1), KC_RALT, KC_RGUI, KC_RCTRL}
  },
  {
...
{
  {
    ...
    {KC_LCTRL, KC_LGUI, KC_LALT, KC_NO, KC_NO, KC_SPACE, KC_SPACE, KC_SPACE, KC_NO, KC_NO, KC_APP, KC_RALT, KC_RGUI, KC_RCTRL}
  },
};
